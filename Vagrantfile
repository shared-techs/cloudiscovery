...
Vagrant.configure("2") do |config|
  ...
  # "privileged: false" is needed so that pyenv is installed in the user directory
  # and right bashrc file is updated
  config.vm.provision "shell", privileged: false, inline: <<-SHELL
    ...
    pyenv install 3.8.0 > /dev/null 2>&1
    pyenv global 3.8.0 > /dev/null 2>&1
